namespace U8.Interface.Bus.ApiService.Setting
{
    partial class FrmConnectSetting
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FrmConnectSetting));
            ...
            this.Text = "服务链接设置";
            this.TopMost = true;
            this.Load += new System.EventHandler(this.FrmConnectSetting_Load);
            this.Shown += new System.EventHandler(this.FrmConnectSetting_Shown);
            this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.FrmConnectSetting_FormClosing);
