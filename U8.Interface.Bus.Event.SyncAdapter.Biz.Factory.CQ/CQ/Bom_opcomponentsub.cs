namespace U8.Interface.Bus.Event.SyncAdapter.Biz.Factory.CQ
{
    ...
    public class Bom_opcomponentsub : BizBase
    {
        ...
        public Bom_opcomponentsub(ref Connection conn, ref DataSet ds, string ufConnStr, string opertype) : base(conn, ufConnStr)
        {
            base.oracleTableName = "MES_CQ_Bom_opcomponentsub";
            base.oraclePriKey = "bomid";
            base.fieldcmpTablename = "MES_CQ_bom_bom";
            base.ufTableName = "Bom_opcomponentsub";
            base.ufPriKey = "bomid";
            this.opertype = opertype;
            this.ds = ds;
        }

        public Bom_opcomponentsub(ref Connection conn, int bomId, string ufConnStr, string opertype) : base(conn, ufConnStr)
        {
            base.oracleTableName = "MES_CQ_Bom_opcomponentsub";
            base.oraclePriKey = "bomid";
            base.fieldcmpTablename = "MES_CQ_bom_bom";
        ...
        public override StringBuilder CreateDeleteString()
        {
            ...
            {
                return new StringBuilder(string.Concat(new object[] { " DELETE FROM ", base.oracleTableName, " WHERE  ", base.oracleTableName, ".did in ( select MES_CQ_Bom_opcomponent.did from MES_CQ_Bom_opcomponent where MES_CQ_Bom_opcomponent.id in( select id from MES_CQ_bom_bom with(nolock) where  bomid ='", this.bomId, "')  )" }));
            }
