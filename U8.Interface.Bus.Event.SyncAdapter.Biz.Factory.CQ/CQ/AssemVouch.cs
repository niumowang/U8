namespace U8.Interface.Bus.Event.SyncAdapter.Biz.Factory.CQ
{
    ...
    public class AssemVouch : BizBase
    {
        private string _cAVCode;
        private AssemVouchs detailBiz;

        public AssemVouch(ref Connection conn, IXMLDOMDocument2 doc, IXMLDOMDocument2 docbody, string ufConnStr, string _opertype) : base(conn, ufConnStr)
        {
            base.oracleTableName = "MES_CQ_AssemVouch";
            base.oraclePriKey = "cAVCode";
            base.fieldcmpTablename = "MES_CQ_AssemVouch";
        ...
        public override DataTable GetSourceData(string sourceTableName, string sourceKeyName, string sourceKeyValue, string colNames)
        {
            ...
            string str2 = "SELECT " + colNames + " FROM " + base.ufTableName + "  WHERE cVouchType = '13' AND cAVCode ='" + this._cAVCode + "' ";
        ...
        private void SetData(string cAVCode)
        {
            ...
            this.detailBiz = new AssemVouchs(ref this.conn, cAVCode, base.ufConnStr, base.opertype);
