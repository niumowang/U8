...
namespace U8.Interface.Bus.ApiService.Voucher.OP.Factory.DS
{
    ...
    public class RdRecord10 : StockOP
    {
        ...
        private string sourceVoucherNoColumnName = "MOCODE";
        ...
        private string headtable = "MES_Int_rdrecord10";
        private string bodytable = "MES_Int_rdrecord10"; 
        ...
        { 
            ...
            string sql = "select t.*,lt.cWhCode as mes_cWhCode ,lt.cRdCode as cCode ";
            sql += ",'" + System.DateTime.Now.ToString(SysInfo.dateFormat) + "' as ddate ";
            sql += ",'生产订单' as cSource ";
            sql += " from  v_mom_order_wf t with(nolock) left join " + headtable + " lt with(nolock) on lt.[mocode] = t.[mocode] where lt.id ='" + pdt.Id + "' ";
