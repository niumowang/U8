...
namespace U8.Interface.Bus.Event.SyncAdapter.Biz.Factory.DS 
{
    ...
    { 
            ...
            : base(conn, ufConnStr)
        {
            ...
            oracleTableName = "MES_Mom_orderdetail";   //目标表名
            oraclePriKey = "MoId";      //目标表主键 
            fieldcmpTablename = "mom_orderdetail";
            ufTableName = "mom_orderdetail";       //来源表名
            ufPriKey = "MoId";          //来源表主键
        ...
        {
            string sql = "SELECT " + colNames + " FROM " + sourceTableName + " with(nolock) WHERE moid =" + sourceKeyValue + " and modid =" + Convert.ToString(_modid) + " ";
